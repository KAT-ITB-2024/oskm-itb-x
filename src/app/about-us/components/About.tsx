  ...
  return (
    <div className="relative">
      ...
      <div className="mx-auto mt-52 w-9/12 text-white lg:mt-64 lg:w-7/12">
        <h1 className="text-center font-mogula text-3xl [text-shadow:4px_4px_10px_#0CEBCCBF] lg:text-5xl">
          About Us
        </h1>
        <p className="mt-14 text-justify font-rem text-xs sm:text-sm md:text-base lg:mt-32 lg:text-lg xl:text-xl">
