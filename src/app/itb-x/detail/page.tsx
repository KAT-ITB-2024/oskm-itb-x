...
export default function DetailPage() {
  return (
    <main className="min-h-screen bg-[url('/itb-x/bg-detail.png')] bg-cover bg-center py-20">
      <div className="mx-10 mt-20 flex flex-col items-center justify-center gap-y-20">
        {/* images carousel */}
        <div></div>
        {/* hari jadi */}
        <div className="flex w-full flex-col items-center rounded-[40px] bg-[url('/itb-x/bg-detail.png')] bg-cover bg-center py-4 font-mogula text-2xl text-white">
          <p>Hari Jadi</p>
        ...
        <div>
          <div className="flex flex-row items-center justify-between">
            <div className="h-4 w-24 rounded-2xl bg-[url('/itb-x/bg-line.png')] bg-cover bg-center"></div>
            <h1 className="font-mogula text-2xl text-white">About Us</h1>
            <div className="h-4 w-24 rounded-2xl bg-[url('/itb-x/bg-line.png')] bg-cover bg-center"></div>
          </div>
          <div className="rounded-2xl bg-[#A2F8F3] p-6">
            <p className="h-[600px] overflow-y-scroll rounded-2xl bg-[url('/itb-x/bg-desc.jpg')] bg-cover bg-center p-6 text-justify">
