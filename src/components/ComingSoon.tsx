...
const ComingSoon = () => {
  return (
    <div className="relative flex h-screen w-full items-center justify-center bg-[url('/coming-soon/blue_background.png')] bg-cover bg-center bg-no-repeat">
      <div className="relative z-10 flex aspect-square w-[80%] max-w-lg justify-center md:w-full">
        <Image
          src="/coming-soon/coming-soon-bubble.png"
        ...
        <div className="my-10 flex h-fit w-3/4 flex-col items-center justify-center md:my-16">
          <Image
            src="/coming-soon/coming-soon.svg"
      ...
      <Image
        src="/coming-soon/first-ubur.png"
      ...
      />
      <Image
        src="/coming-soon/second-ubur.png"
      ...
      />
      <Image
        src="/coming-soon/third-ubur.png"
